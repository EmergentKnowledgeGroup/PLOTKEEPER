...
This release is `0.1.2`. Before declaring the local dashboard ready, verify
...
git diff ecc8a01f58732ac04de4995cfc10b7840b87377c..HEAD --check
...
`ecc8a01f58732ac04de4995cfc10b7840b87377c`. If the active-run surface release is
...
git push --force-with-lease=refs/heads/main:<REMOTE_FAILED_SHA> origin `
  ecc8a01f58732ac04de4995cfc10b7840b87377c:refs/heads/main
```
...
removes only the active-run surface patch from the public branch; it preserves
the attested `0.1.1` panel-reliability release, repository, and audit history.
