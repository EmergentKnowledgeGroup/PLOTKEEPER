...
- step: PR-open
- note: PR 1 is open against main and intentionally unmerged while CodeRabbit and GitHub Actions review the exact release slice.
- branch: release/v0.1.7-plotkeeper-surface
- head: 8ab3cff
- next_cmd: `gh pr checks 1 && gh pr view 1 --comments`
