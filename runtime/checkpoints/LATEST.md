...
- note: Panel reliability package integrated: non-empty handler errors, fail-closed owned-listener replacement, HTML-gated panel receipts, message/session identity repair, stable canonical-task reuse, and version 0.1.1 docs/changelog; exact-candidate review and release remain.
- branch: main
- head: 5c33658
